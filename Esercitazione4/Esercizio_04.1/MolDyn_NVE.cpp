...
int main(){ 
	...
	for(int istep = 1; istep <= nstep; ++istep){
    	...
    	if (istep == nstep-1)  	//At the step before the last write the old final configuration 
    			WriteOldFinal();
    	if(istep%10 == 0){ 			//Measure stuff and write configuration every 10 Monte Carlo steps 
